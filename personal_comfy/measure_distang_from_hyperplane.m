function [distout, insubspace, angleout] = measure_distang_from_hyperplane(plane, points, varargin)
...
% varargin:
%   'addint' : add ones, which has mean centering effect. default is false
